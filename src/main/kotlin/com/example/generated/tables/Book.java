...
public class Book extends TableImpl<BookRecord> {
     ...
     */
    public final TableField<BookRecord, Integer> PUBLICATION_STATUS = createField(DSL.name("publication_status"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<Check<BookRecord>> getChecks() {
        return Arrays.asList(
            ...
            Internal.createCheck(this, DSL.name("book_publication_status_check"), "((publication_status = ANY (ARRAY[0, 1])))", true)
        );
    }
